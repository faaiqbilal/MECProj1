...
class MeasQuantityResultsNr(object):
    ...
    def __init__(self, rsrp=None, rsrq=None, sinr=None):  # noqa: E501
        """MeasQuantityResultsNr - a model defined in Swagger"""  # noqa: E501
        self._rsrp = None
        self._rsrq = None
        self._sinr = None
    ...
    @property
    def rsrp(self):
        """Gets the rsrp of this MeasQuantityResultsNr.  # noqa: E501

        Reference Signal Received Power as defined in ETSI TS 138 331 [i.13].  # noqa: E501

        :return: The rsrp of this MeasQuantityResultsNr.  # noqa: E501
        :rtype: int
        """
        return self._rsrp
    ...
    @property
    def rsrq(self):
        """Gets the rsrq of this MeasQuantityResultsNr.  # noqa: E501

        Reference Signal Received Quality as defined in ETSI TS 138 331 [i.13].  # noqa: E501

        :return: The rsrq of this MeasQuantityResultsNr.  # noqa: E501
        :rtype: int
        """
        return self._rsrq
    ...
    @property
    def sinr(self):
        """Gets the sinr of this MeasQuantityResultsNr.  # noqa: E501

        Reference Signal to Interference & Noise Ratio as defined in ETSI TS 138 331 [i.13].  # noqa: E501

        :return: The sinr of this MeasQuantityResultsNr.  # noqa: E501
        :rtype: int
        """
        return self._sinr
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MeasQuantityResultsNr, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MeasQuantityResultsNr):
            return False
