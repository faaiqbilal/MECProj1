...
class RabEstSubscriptionFilterCriteriaQci(object):
    ...
    def __init__(self, app_instance_id=None, ecgi=None, qci=None):  # noqa: E501
        """RabEstSubscriptionFilterCriteriaQci - a model defined in Swagger"""  # noqa: E501
    ...
    def app_instance_id(self):
        """Gets the app_instance_id of this RabEstSubscriptionFilterCriteriaQci.  # noqa: E501

        Unique identifier for the MEC application instance.  # noqa: E501

        :return: The app_instance_id of this RabEstSubscriptionFilterCriteriaQci.  # noqa: E501
        :rtype: str
        """
    ...
    @property
    def ecgi(self):
        """Gets the ecgi of this RabEstSubscriptionFilterCriteriaQci.  # noqa: E501

        E-UTRAN Cell Global Identifier.  # noqa: E501

        :return: The ecgi of this RabEstSubscriptionFilterCriteriaQci.  # noqa: E501
        :rtype: list[Ecgi]
        """
        return self._ecgi
    ...
    @property
    def qci(self):
        """Gets the qci of this RabEstSubscriptionFilterCriteriaQci.  # noqa: E501

        QoS Class Identifier as defined in ETSI TS 123 401 [i.4].  # noqa: E501

        :return: The qci of this RabEstSubscriptionFilterCriteriaQci.  # noqa: E501
        :rtype: int
        """
        return self._qci
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RabEstSubscriptionFilterCriteriaQci, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RabEstSubscriptionFilterCriteriaQci):
            return False
